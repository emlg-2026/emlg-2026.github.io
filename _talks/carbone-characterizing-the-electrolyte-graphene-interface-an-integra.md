---
name: 'Characterizing the electrolyte/graphene interface: an integrated approach with modelling and experiments'
speakers:
- Paola Carbone
...
email: paola.carbone@manchester.ac.uk
...
![Figure from Carbone1.docx]({{ '/assets/abstracts/carbone-characterizing-the-electrolyte-graphene-interface-an-integra/figure-1.jpeg' | relative_url }})
