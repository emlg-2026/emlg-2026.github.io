---
name: 'On the Aggregation of Amphiphiles in Water: Hydrotropy as the missing link between salts and surfactants'
speakers:
- João Coutinho
track: Session 5
invited: true
...
![Figure from EMLG_JMLG_2026_JCoutinho.docx]({{ '/assets/abstracts/coutinho-on-the-aggregation-of-amphiphiles-in-water-hydrotropy-as-the/figure-1.png' | relative_url }})
