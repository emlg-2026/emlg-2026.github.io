---
name: 'Mixing, De-mixing and Molecular Aggregation in Aqueous Solutions: Molecular Dynamics Simulation and Graph Theoretical Analysis'
speakers:
- Jun-Ho Choi
track: Session 6
authors:
...
![Figure from Choi1.docx]({{ '/assets/abstracts/choi-mixing-de-mixing-and-molecular-aggregation-in-aqueous-soluti/figure-1.png' | relative_url }})

Figure 1 – Molecular aggregation behavior in triethylamine (TEA)-water mixture.

At lower temperature, the small-sized TEA aggregates are compatible with liquid water, but large self-associated aggregates are separated from liquid water at higher temperature in TEA-water mixture.

### References

[1] J.-H. Choi, H. Lee, H. R. Choi, and M. Cho, Annu. Rev. Phys. Chem., 69, 125, (2018).

[2] S. Parameswaran, S. Choi, and J.-H. Choi, J. Mol. Liq., 347, 118339 (2022).

[3] R. Singh, J. Seo, J. Ryu, and J.-H. Choi, Phys. Chem. Chem. Phys., 26, 18970 (2024)

[4] R. Singh, J. Ryu, and J.-H. Choi, J. Mol. Liq., 440, 128983 (2025).
