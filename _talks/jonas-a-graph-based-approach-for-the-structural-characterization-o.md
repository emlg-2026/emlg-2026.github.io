---
name: A Graph-based approach for the structural characterization of macromolecules and their interactions with the environment
speakers:
- Katrin Jonas
track: Session 7
authors:
...
![Figure from Jonas1.docx]({{ '/assets/abstracts/jonas-a-graph-based-approach-for-the-structural-characterization-o/figure-1.png' | relative_url }})
